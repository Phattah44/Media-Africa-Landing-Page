...
const AboutUs = () => {
  return (
    <div className='bg-[#F4F6FD] p-10'>
      <h1 className='text-[#040C5E] text-center font-bold p-5'>ABOUT US</h1>
      <div className='flex flex-col gap-5 mx-auto '>
        <h1 className='text-[#040C5E] text-center'>
        ...
        <h1 className='text-[#040C5E] text-center'>
          We help innovative companies get bigger, stronger, and more exciting.
        </h1>
        <h2 className='text-[#040C5E] text-center'>
          At Media Africa, we believe in quality results and service. We’ve
          built a client-centric company that delivers industry-leading results.
          We have high ranking influencers Across Africa with millions of
          followers and audience ready to adopt all your projects.
        </h2>
        <h1 className='text-[#040C5E] text-center'>
      ...
      <h1 className='text-[#040C5E] text-center p-10 font-bold'>SERVICES</h1>
      <div className='flex justify-around'>
        <div className='flex flex-col mt-8 bg-[#040C5E] text-white w-[180px] h-[310px] p-3 rounded-xl'>
